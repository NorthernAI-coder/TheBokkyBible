#!/usr/bin/env bash
#
# 07_buildEmbeddingsWords.sh
# Usage: ./07_buildEmbeddingsWords.sh [options...]
#        ./07_buildEmbeddingsWords.sh --corpus-dir docs/ --output-dir projector_data/
#
...
OUTPUT_DIR="$REPO_ROOT/projector_data/words"
...
python "$SCRIPT_DIR/embed_repo_words.py" \
